...
Una **leyenda** sobre el gráfico nombra cada color y estilo presente según los toggles activos (conteo primario con el color de su patrón, EMA 50/200, Fibonacci, y cuando corresponde Soporte/Resistencia/VWAP/Convergencia/Proyección), así no hay que adivinar qué es cada línea. Click en una tarjeta del panel aísla ese conteo; otro click vuelve a la vista general. Todos los escenarios siguen disponibles en el panel lateral aunque no se dibujen.
